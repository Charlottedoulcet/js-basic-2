...
if (typeof value === "number") {
  ...
  console.log("No es mi numero de string");
}
//BUCLES
...
for (const index in programmers) {
  ...
  console.log(`${index}: ${programmer.name}, su aporte fue ${programmer.knowledge}.`);
}
...
console.log(calcularAreaRectangulo(8, 2));
